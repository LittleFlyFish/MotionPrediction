...
parse.add_argument("--checkpoint", help="specify which model to load in", default=80000, type=int)
...
if args.dataset=="human3.6m":
    ...
    if not args.is_sampling:
        dloader=VAE.Data_cmu(50,  25, PATH + '/data/cmu_mocap/train', PATH + '/data/cmu_mocap/test')
    else:
        dloader = VAE.Data_cmu(50, args.output_length, PATH +'/data/cmu_mocap/train',PATH + '/data/cmu_mocap/test')
