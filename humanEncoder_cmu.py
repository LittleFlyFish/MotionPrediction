...
class Discriminator(VAE.DiscriminatorBase):
    ...
    def forward(self, data_input, input_class,
        ...
        with tf.variable_scope(self.name_scope) as vs:
            ...
            global_result = tcl.fully_connected(h0, 1, activation_fn=None,
                                                weights_regularizer=tcl.l2_regularizer(self.re_term))

            local_h0 = tcl.fully_connected(dec_in_enc, self.nfilters * 8, scope="fc2",
                                           weights_regularizer=tcl.l2_regularizer(self.re_term))

            local_result = tcl.fully_connected(local_h0, 1, activation_fn=None,
                                               weights_regularizer=tcl.l2_regularizer(self.re_term))
